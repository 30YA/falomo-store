      ...
      <Container>
        ...
        <div className="mt-4 overflow-hidden rounded-2xl bg-[var(--color-ink)] p-6 text-white sm:mt-6 sm:rounded-3xl sm:p-10">
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              <h3 className="text-xl font-bold sm:text-2xl">خواب بهتر، زندگی بهتر</h3>
              <p className="mt-2 max-w-xl text-sm text-white/75">
                در فالومو مجموعه‌ای از روتختی، ملحفه، بالش و تشک را با الهام از تجربه
                خرید فروشگاه‌های بزرگ ایرانی طراحی کرده‌ایم.
              </p>
            </div>
            <Link
              href="/products"
