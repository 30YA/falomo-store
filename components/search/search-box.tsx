  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={cn(
          "h-11 w-full rounded-xl border border-transparent bg-[var(--color-surface)] pr-10 pl-10 text-sm outline-none transition focus:border-[var(--color-brand)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(249,115,22,0.12)]",
          inputClassName,
        )}
      />
      {query && (
